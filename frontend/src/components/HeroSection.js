    ...
    <section className="bg-green-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 text-center">
            ...
            <div className="mt-8 flex justify-center">
                <button className="bg-green-600 text-white font-bold py-3 px-8 rounded-full text-lg hover:bg-green-700 transition-transform transform hover:scale-105 shadow-lg">
                    Shop Now
                </button>
            </div>
        </div>
